<%-- 
    Document   : listarLibrosCliente
    Created on : 20 nov 2024, 1:30:45 p. m.
    Author     : YEIMI
--%>
     ...
     <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <%
                    ...
                    List<Libros>list=dao.listarLibrosClientes();
           ...
           <a href="MenuCliente.jsp" class="form__button">Regresar</a>
        </div>
    </body>
  </div>
</div>
