                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-warning" href="ClienteServlet?accion=editar&id=<%= per.getID_Cliente()%>">Editar</a>
                            <a class="btn btn-danger" href="ClienteServlet?accion=eliminar&id=<%= per.getID_Cliente()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
